...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center><br />
                 <asp:Label ID="Label5"  runat="server" Text="تقرير اجمالى مرات تكرار اخطاء مدخل البيانات" ForeColor="#996633" Font-Bold="True"></asp:Label>
                <br />
    ...
    <center>
     <table border="0" width ="100%" dir="rtl">
        <tr>
        <td>
            <asp:Label ID="lblentry" runat="server" Text="مدخل البيانات"></asp:Label>
