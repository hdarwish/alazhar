<%@ Page Language="C#" MasterPageFile="~/masterpage/InnerMaster.master" AutoEventWireup="true"
    CodeFile="tvAudioList.aspx.cs" Inherits="Esdarat_tvAudioList" Title="Untitled Page" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <table id="Table1" runat="server" align="<%$Resources:Master, align%>" dir="<%$Resources:Master, dir%>" width="100%">
        <%-- <tr>
                    ...
                    <table id="Table1" dir="<%$Resources:Master, dir%>" runat="server" align="<%$Resources:Master, align%>" cellpadding="10">
                        <tr valign="top" align="<%$Resources:Master, align%>" runat="server"  >
                            ...
                            <td  runat="server" align="<%$Resources:Master, align%>" dir="<%$Resources:Master, dir%>">
                                ...
                                <asp:LinkButton ID="VedioTitle" runat="server" CssClass="text" Font-Underline="true" Font-Bold="true"
                                    Font-Size="15px"  ></asp:LinkButton>
                        ...
                        <tr align="<%$Resources:Master, align%>" dir="<%$Resources:Master, dir%>" runat="server" valign="top">
                            <td style= "<%$Resources:Master, subTitle_align%>" class="books_title_text" align="<%$Resources:Master, align%>" runat="server" dir="<%$Resources:Master, dir%>"  colspan="2">
                                <asp:Label ID="Label2" runat="server" Text="<%$Resources:Master, key_Guest_name%>"
                                align="<%$Resources:Master, align%>" dir="<%$Resources:Master, dir%>"></asp:Label>
                                <asp:Label ID="Labguest" runat="server" Text="" CssClass="books_texts"
                                 align="<%$Resources:Master, align%>" dir="<%$Resources:Master, dir%>"></asp:Label>
                            </td>
                        </tr>
                        </table>
