<%@ Page Language="C#" MasterPageFile="~/masterpage/InnerMaster.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="events_Default" Title="Untitled Page" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <input id="hidden_id" type="hidden" runat="server" />
    <table      border="0"  width="100%" dir="<%$Resources:Master, dir%>" runat="server">
        ...
        <tr align="<%$Resources:Master, align%>">
            <td align="<%$Resources:Master, align%>" colspan="3" width="100%" dir="<%$Resources:Master, dir%>">
                <table id="tableList" runat="server" runat="server" visible="false" style="vertical-align: top"
                ...
                <table id="tableBoth" runat="server" visible="false" style="vertical-align: top"
                    align="<%$Resources:Master, align%>" dir="<%$Resources:Master, dir%>" width="100%">
                    <tr valign="top">
