...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <ContentTemplate>
         ...
         <center>
        <br />
    <asp:Label ID="Label5"  runat="server" Text="تقرير اجمالى اخطاء مراقب جودة ملفات" ForeColor="#996633" Font-Bold="True"></asp:Label>
                <br />
    ...
    <table width="100%" dir="rtl" border="0">
        <tr>
            <td>
                <asp:Label ID="Label24" runat="server" Text="Label">مراقب جودة الملفات</asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:DropDownList 
