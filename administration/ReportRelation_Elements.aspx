<%@ Page Title="تقرير العناصر المرتبطة بعنصر معين" Language="C#" MasterPageFile="~/masterpage/AdminMasterPage.master"
    ...
    <table width="100%" dir="rtl">
        <tr>
            <td colspan="2">
                ...
                <asp:Label ID="Label1" runat="server" Text="تقرير تفصيلى بالعناصر المرتبطة بعنصر معين" Font-Bold="True"
