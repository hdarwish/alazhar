...
<table width="650px" runat="server" dir="<%$Resources:Master, dir%>">
   
                 
                    <tr valign="top" runat="server" dir="<%$Resources:Master, dir%>">
                        <td align="center"  runat="server" dir="<%$Resources:Master, dir%>">
