<%@ Page Language="C#" MasterPageFile="~/masterpage/AdminMasterPage.master" AutoEventWireup="true"
    CodeFile="observing_data_entry.aspx.cs" Inherits="administration_entry_form" Title="شاشة إدخال الاستمارات"
    ...
    <table width="100%" dir="rtl">
        <tr>
            <td colspan="2" class="style1">
                ...
                <asp:Label ID="Label24" runat="server" Text="Label">مراجع البيانات</asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:DropDownList ID="DropDownList1" runat="server" 
                    DataSourceID="SqlDataSource2observing_data_entry_live" DataTextField="name" 
                    DataValueField="name" 
                    onselectedindexchanged="DropDownList1_SelectedIndexChanged1" 
                    AppendDataBoundItems="True">
                    <asp:ListItem>none</asp:ListItem>
                    <asp:ListItem Value="الكل">الكل </asp:ListItem>
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource2observing_data_entry_live" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:azhar_liveConnectionString %>" 
                    SelectCommand="observing_of_Data_Entry_live" 
