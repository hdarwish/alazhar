                ...
                <td>
                    <div class="accordion_title" id="trshohra" runat="server">
                        <a href="#" class="text_Brown_10pt_bold">
                            <asp:Label ID="txt_other_name" runat="server" class="text_Brown_10pt_bold"></asp:Label>
                        </a>
                    </div>
                    ...
                    <div class="accordion_title" id="trname" runat="server">
                        <a href="#" class="text_Brown_10pt_bold">
                            <asp:Label ID="txt_name_tr" runat="server" class="text_Brown_10pt_bold" Text="<%$ Resources:Master, Lbl_character_name %>"></asp:Label>
                        <asp:Label ID="txt_name" runat="server" class="text_Dark_Brown_10pt"></asp:Label>
                        </a>
                    </div>
