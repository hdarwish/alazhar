<%@ Page Language="C#" MasterPageFile="~/masterpage/InnerMaster.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="sheikhs_Default" Title="Sheikhs Page" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <input id="hidden_id" type="hidden" runat="server" />
    <table runat="server" width="100%" dir="<%$Resources:Master, dir%>">
        ...
        <table dir="<%$Resources:Master, dir%>" runat="server">
        <tr  runat="server" align="<%$Resources:Master, align%>" valign="top">
            <td align="<%$Resources:Master, align%>"  colspan="2" style="padding-top:3px">
                <table runat="server" cellpadding="0" border="1" dir="<%$Resources:Master, dir%>"
            ...
            <td align="<%$Resources:Master, align%>"  width="65px">
        ...
        <table align="<%$Resources:Master, align%>" runat="server" width="100%" dir="<%$Resources:Master, dir%>">
                            ...
                            <asp:ListView ID="ListView1" runat="server" GroupItemCount="1" ItemPlaceholderID="itemPlaceholder">
                                ...
                                <ItemTemplate>
                                    <tr id="Tr2" runat="server">
                                        ...
                                        <td runat="server" align="<%$Resources:Master, align%>" valign="top" style="width: 97%;">
        ...
        <table>
        <tr align="center">
            <td runat="server" align="center" colspan="4" width="100%" dir="<%$Resources:Master, dir%>">
