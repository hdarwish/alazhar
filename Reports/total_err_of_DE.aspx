    ...
    <table width="100%" dir="rtl">
        <tr>
            <td colspan="2" class="style1">
                ...
                <asp:SqlDataSource ID="SqlDataSource1Data_Entry" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:AZHARMDFConnectionString %>" 
                    SelectCommand="Data_Entry" SelectCommandType="StoredProcedure">
                </asp:SqlDataSource>
                <br />
                <br />
                </asp:SqlDataSource>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList 
                    ...
                    DataSourceID="SqlDataSource2Data_entry_live" DataTextField="name" 
                    DataValueField="name" 
                    onselectedindexchanged="DropDownList1_SelectedIndexChanged1">
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource2Data_entry_live" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:azhar_liveConnectionString %>" 
                    SelectCommand="Data_Entry_live" SelectCommandType="StoredProcedure">
                </asp:SqlDataSource>
