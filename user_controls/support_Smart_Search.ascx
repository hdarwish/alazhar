<%@ Control Language="C#" AutoEventWireup="true" CodeFile="support_Smart_Search.ascx.cs"
    Inherits="support_Smart_Search" %>
        ...
        <tr>
            <td>
                <div  runat="server" id="Div_Code" onclick="ChangeDivCase('<%=Div_Grid.ClientID%>');">
                    ...
                    <asp:TextBox ID="txt_Id" AutoPostBack="true" BackColor="#C8C8C8" OnTextChanged="support_txt_Id_TextChanged"
            ...
            <td>
                <div onclick="ChangeDivCase('<%=Div_Grid.ClientID%>');">
                    ...
                    <asp:TextBox ID="txt_Name" runat="server" BackColor="#C8C8C8" Width="200px" AutoPostBack="true"
                        OnTextChanged="support_txt_Name_TextChanged"></asp:TextBox>
                </div>
            </td>
            <td>
                <div>
