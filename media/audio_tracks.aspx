<%@ Page Language="C#" MasterPageFile="~/masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="audio_tracks.aspx.cs" Inherits="Audio_Tracks" Title="Audio Tracks" %>
...
<div id="Div1" runat="server" align="center" style="width: 100%" >
    <h1 align="center" 
            ...
            style="height: 40px; width: 512px; vertical-align: middle;">
				<div id="divFilter" runat="server" align="center" style="height: 30px; float:left;">
        ...
        style="border-style: solid; border-width: 1px;width:590px; height: 25px;">
				    <asp:Label ID="lbl213" runat="server" Text="اسم العمل" width="525px" Font-Bold="true"> </asp:Label>
				     ...
				     <asp:Label ID="Label1" runat="server" Text="استماع" width="40px" 
                        Font-Bold="True"></asp:Label>
				</div>--%>
				<div id="Div2" runat="server"  style="width:595px;vertical-align:middle">
        <asp:DataList  ID="DLAudio" runat="server" RepeatDirection="Vertical" 
	            RepeatColumns="1"    GridLines="Both" HorizontalAlign="Right" >
							    ...
							    <a href='<%# "audio_player.aspx?playaudioid=" + Eval("id") %>'  style="text-decoration: none;" >
                                      &nbsp;&nbsp;&nbsp;&nbsp;<img  style="vertical-align:bottom;border-width:0px"  width="20px" height="20px" src="../images/headphone.png">
                                          </a>
							    &nbsp;&nbsp;<asp:Label ID="lblname" runat="server" Text='<%#Eval("title")%> ' width="500px" > </asp:Label>
		                        
		                           
                                        &nbsp;<img  style="vertical-align:text-top;border-width:0px"  src="../images/bullet.png" ></div>
...
<asp:button id="cmdPrev" runat="server" text=" السابق " onclick="cmdPrev_Click"></asp:button>
         ...
         <%--     
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [file_name], [extension] FROM [content_media] where [content_type]=2"></asp:SqlDataSource>
			--%>			
    </div>
    </asp:Content>